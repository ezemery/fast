...
function Question(props) {
	const { answers, question, author, date, votes } = props;
	return (
		...
		<div className="faq-page">
			...
			<div className="section-1">
				...
				<div className="section-1-desc">
					Find answers and let’s help you get sorted out
					<br /> and set up with Fast.
				</div>
			...
			<div className="d-flex justify-content-center">
				<div className="section-3">
					<div className="section-3-question">
						What happens on this FAQ page when I click on an answer to view more?
					</div>
					<div className="section-3-answer">
						When you click on an answer to view more, the answer field expands and the full answer comes
						into view on this same page without loading another. In that way the user does not have to view
						another page to get their responses and can keep on learning more on our FAQ page. Rather than
						have stars as well to show how relevant a post is, it is my opinion that we have a mini survey
						at the bottom of each response to rate the quality of the response. Good, bad or okay.
					</div>
					<div className="section-3-code"></div>
					<div className="section-3-answer">
						The answers that appear on top of the page would be determined by the number of upvotes. This
						helps rank the most frequently asked questions dynamically. Although when a user puts in a
						search query for a response, his search turns up the most relevant results.
					</div>
					<div className="section-3-row">
						<div className="section-3-row-left">
							<div className="section-3-row-author">Domm Holland, CEO Fast AF</div>
